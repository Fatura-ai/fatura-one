...
export const homeEn: HomeContent = {
  heroTitle: "Welcome to Postara",
  heroSubtitle:
    "Manage all your social platforms in one place. Schedule, caption, and post everywhere with one click.",
  ...
  analyticsText:
    "Track engagement and performance across all platforms in real time.",

  readyTitle: "Ready to simplify your social media?",
  ctaPlans: "View Plans",
};
